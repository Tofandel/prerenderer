...
import IRenderer, { RenderedRoute } from '@prerenderer/prerenderer/src/IRenderer'
import { ServerOptions } from '@prerenderer/prerenderer/src/options'

export type WebpackPrerenderSPAOptions = {
  indexPath?: string
  entryPath?: string
  renderer?: IRenderer
  routes: Array<string>
